...
class _ShowData extends State<newOrder2> {
            ...
            child: Column(
              children: <Widget>[
                Container(
                  child: new ListTile(
                    leading: ClipOval(
                      child: Image.network(menu.orderList[idx].image, fit: BoxFit.cover,
                        height: 70,
                        width: 60,),
                    ),
                    title: Text('ราคา: ' +
