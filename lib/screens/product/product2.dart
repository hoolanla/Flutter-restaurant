...
class ProductPage2 extends StatefulWidget {
  final data;
  ProductPage2(this.data);

  @override
  ProductState createState() => new ProductState();
}

class ProductState extends State<ProductPage2> {
  ...
  Widget build(BuildContext ctx) {
    ...
    final cartBloc2 = BlocProvider.of(context).cartBloc;

    return new Directionality(
        textDirection: TextDirection.rtl,
        child: new StreamBuilder(
          stream: cartBloc2.cart,
                              ...
                              new Row(
                                ...
                                children: <Widget>[
                                  new IconButton(
                                    ...
                                    onPressed: () {
                                      cartBloc2.remove.add(widget.data);
                                    },
                                  ),
                                  new Text(
                                    '1',
                                  ...
                                  new IconButton(
                                    icon: Icon(Icons.add),
                                    onPressed: () {
                                      cartBloc2.addition.add(widget.data);
                                    },
                                  ),
                                ],
                              ),
